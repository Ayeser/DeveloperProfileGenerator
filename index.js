                    ...
                    axios
                        ...
                        .then(function (res) {
                          const colors = {
                            ...
                            generatedProfile = generatedProfile + "</head><div class='wrapper'><div class='photo-header'><img class='photo-header img' src='" + res.data.avatar_url + "' alt='Profile Picture'></div><h2 class='photo-header h2'>Hi! My name is " + res.data.login + "</h2><div class='row'><div class='nav-link col'>Located in " + res.data.location + "</div><div class='links-nav col'>Blog and Github " + res.data.blog + "</div></div></div><body><main class='container'><div class='row'><h3>" + res.data.bio + "</h3></div><div class='row'><div class='col'><div class='card'>Public Repositories: " + res.data.public_repos + "</div></div><div class='col'><div class='card'>Followers: " + res.data.followers + "</div></div></div><div class='row'><div class='col'><div class='card'>Github Stars: " + res.public_gists + "</div></div><div class='col'><div class='card'>Following: " + res.data.following + "  </div></div></main><script src='https://code.jquery.com/jquery-3.3.1.slim.min.js' integrity='sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo' crossorigin='anonymous'></script><script src='https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js' integrity='sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1' crossorigin='anonymous'></script><script src='https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js' integrity='sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM' crossorigin='anonymous'></script></body><footer class='wrapper'></footer></html>";
                            ...
                            generatedProfile = generatedProfile + "</head><div class='wrapper'><div class='photo-header'><img class='photo-header img' src='" + res.data.avatar_url + "' alt='Profile Picture'></div><h2 class='photo-header h2'>Hi! My name is " + res.data.login + "</h2><div class='row'></div></div><body><main class='container'><div class='row'><br /><div class='nav-link col'>Located in " + res.data.location + "</div><div class='links-nav col'>Blog and Github " + res.data.blog + "</div><br /><h3>" + res.data.bio + "</h3></div><div class='row'><div class='col'><div class='card'>Public Repositories: " + res.data.public_repos + "</div></div><div class='col'><div class='card'>Followers: " + res.data.followers + "</div></div></div><div class='row'><div class='col'><div class='card'>Github Stars: " + res.public_gists + "</div></div><div class='col'><div class='card'>Following: " + res.data.following + "  </div></div></main><script src='https://code.jquery.com/jquery-3.3.1.slim.min.js' integrity='sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo' crossorigin='anonymous'></script><script src='https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js' integrity='sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1' crossorigin='anonymous'></script><script src='https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js' integrity='sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM' crossorigin='anonymous'></script></body><footer class='wrapper'></footer></html>";
